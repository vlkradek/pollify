...
export default function CreatePollPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error("Chyba při vytváření ankety:", err);
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <main className="min-h-screen bg-background">
            <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                <div className="rounded-lg border border-border bg-card p-8 shadow-sm">
                    <h1 className="mb-2 font-sans text-3xl font-bold text-card-foreground">
                        Vytvořit novou anketu
                    </h1>
                    <p className="mb-8 text-muted-foreground">
                        Shromážděte názory ostatních vytvořením své ankety
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                        <div>
                            ...
                            />
                            {errors.title && <div className="text-xs text-red-500 font-medium pt-1">{errors.title}</div>}
                        ...
                        <div>
                            ...
                            />
                            {errors.description && <div className="text-xs text-red-500 font-medium pt-1">{errors.description}</div>}
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-xs text-muted-foreground">
                                Přidejte alespoň 2 možnosti, maximálně 10
                            </p>
                            {errors.options && <div className="text-xs text-red-500 font-medium pt-1">{errors.options}</div>}
                        </div>
                        ...
                        <div className="flex gap-3 pt-4">
                            ...
                            >
                                {isLoading ? <Loading /> : "Vytvořit anketu"}
                            </button>
                            <Link
                                href="#"
                                onClick={(e) => {
