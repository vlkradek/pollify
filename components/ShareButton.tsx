...
export default function ShareButton({ pollId, pollTitle }: ShareButtonsProps) {
  ...
  return (
    <div className="mt-6 rounded-lg border border-border bg-card p-6 shadow-sm">
      <h3 className="mb-4 text-lg font-semibold text-card-foreground">Sdílet anketu</h3>

      <button
        onClick={handleNativeShare}
        className="mb-4 flex w-full items-center cursor-pointer justify-center gap-2 rounded-lg bg-primary px-6 py-3 text-base font-semibold text-primary-foreground shadow-sm transition-all hover:bg-primary/90"
      >
        ...
        <>
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-card px-2 text-muted-foreground">Nebo sdílet přes</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className="flex items-center cursor-pointer gap-2 rounded-lg border border-border bg-background px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent"
